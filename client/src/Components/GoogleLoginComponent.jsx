...
class GoogleLoginComponent extends Component{
    render() {
        ...
        return (
            ...
            <Modal show={true}>
                ...
                <Modal.Body>
                    <GoogleLogin
                        clientId="455671908474-refsek97bbp2342pebpvennem53qri1r.apps.googleusercontent.com"
    ...
    return (
        <HandleAuth isLoggedIn={typeof
        this.props.googleReducer.accessToken !== 'undefined'} />
    );
    }
};
